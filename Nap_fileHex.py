...
print("\n======================================================================================")
print("                    CHƯƠNG TRÌNH NẠP CODE STM32 DÙNG FILE HEX")
print("======================================================================================\n")

path_App_Load_code_STM32 = os.path.dirname(os.path.abspath(__file__)) + "\\"

print(Fore.YELLOW+ "> Đường dẫn hiện tại: " + path_App_Load_code_STM32 + "Code_Hex" + Style.RESET_ALL)

files = os.listdir(path_App_Load_code_STM32 + "Code_Hex\\")
...
firmware_path = path_App_Load_code_STM32 + "Code_Hex\\" + hexx
...
while vAutomation: 
    ...
    if keyboard.is_pressed('q'):
            print("\n")
            print(Fore.YELLOW + "> Đã nhấn Quit. Kết thúc chương trình!\n" + Style.RESET_ALL)
            break  
